    ...
    <!-- End of Navbar ---------------------->  
        ...
        <div class="center-page">
            ...
            <div class="col-xs-11 space-vert">
               <% felbergssite_login_aspx login = new felbergssite_login_aspx(); %>
                       
            <button onclick ="<% login.TreatsForTheKids(tbUsername.Text,tbPassword.Text);%>">Log In </button> 
            <asp:Button ID="btnRegister" runat="server" Text="Register" Class="btn" BackColor="#5cb85c" ForeColor="White" OnClick="btnRegister_Click"/>     
            </div>
        </div>
