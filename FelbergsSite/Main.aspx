...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                       <li class ="active"><a href="Main.aspx">Browse</a></li>      
                        <!--If logged in shows "My Account" else "Login"-->                 
                        <asp:PlaceHolder  ID = "MyAccountSwitch" runat="server" /> 
                        ...
                        <li><asp:TextBox ID="tbSearch" runat="server" Class="form-control" /><asp:Button ID="btnSearch" runat="server" Text="Search" Class="btn" BackColor="#5cb85c" ForeColor="White"/></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="display-sidebar">
        ...
        <div class="sidebar-buttons">
         ...
         <!-- Sidebar Ends------------------->      
        <!--Images/prices/names of each game Starts------------>             
             <asp:PlaceHolder  ID = "GameList" runat="server" />    
        <!--Images/prices/names  of each game Ends------------>
